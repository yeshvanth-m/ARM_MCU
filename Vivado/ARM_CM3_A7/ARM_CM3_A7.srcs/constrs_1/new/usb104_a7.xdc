...
create_clock -period $swclk_period -name SWCLKTCK [get_ports {TCK}]
...
### Pmod Header JB
#set_property -dict { PACKAGE_PIN C4    IOSTANDARD LVCMOS33 } [get_ports { TCK }]; #IO_L7P_T1_AD6P_35     Sch=jb[1]
